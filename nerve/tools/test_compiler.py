...
class TestWrapToolFunction(unittest.TestCase):
    @patch("nerve.tools.compiler.state")
    def test_exception_in_wrapped_function_returns_error_string(self, _: MagicMock) -> None:
        def test_func() -> None:
    ...
    def test_no_mime_returns_original_result(self) -> None:
        def test_func() -> str:
            return "test result"
    ...
    def test_image_mime_returns_image_dict(self) -> None:
    ...
    def test_invalid_mime_raises_exception(self, mock_exit: MagicMock, mock_logger: MagicMock) -> None:
        def test_func() -> str:
            return "test result"
