...
pub use crate::api::ollama::generation::functions::request::FunctionCallRequest;

use crate::api::ollama::error::OllamaError;
use crate::api::ollama::generation::chat::request::ChatMessageRequest;
use crate::api::ollama::generation::chat::{ChatMessage, ChatMessageResponse};
use crate::api::ollama::generation::functions::pipelines::RequestParserBase;
use std::sync::Arc;

impl crate::api::ollama::Ollama {
